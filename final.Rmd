...
opioid <- 
  st_read("C:/Users/y4ngz/Desktop/A/MUSA 508/Final/Cinci_Overdoses.geojson") %>% 
...
grid.arrange(ncol=2,
             ggplot() + 
               ...
               geom_sf(data = opioid, colour="darkred", size=0.5, show.legend = "point") +
...
vars_net <- 
  rbind(abandon_cars, dead_animals) %>%
...
reg.vars <- c("Affordable Housing" , "Building Demolition","Tobacco" ,"Tobacco Violation","Vacant Land")
...
reg.summary <- 
  rbind(
    mutate(reg.cv,           Error = Prediction - countshootings,
                             Regression = "Random k-fold CV: Just Risk Factors"),
                             
    mutate(reg.ss.cv,        Error = Prediction - countshootings,
                             Regression = "Random k-fold CV: Spatial Process"),
    
    mutate(reg.spatialCV,    Error = Prediction - countshootings,
